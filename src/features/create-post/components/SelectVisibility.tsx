...
import { CreatePostContextProviderType, useCreatePostContext } from "../contexts/CreatePostContextProvider";
...
function BuildListItem({
    ...
    setVisibility: (visibility: CreatePostContextProviderType['visibility']) => void,
    ctx: ReturnType<typeof useCreatePostContext>,
    visibility: CreatePostContextProviderType['visibility']
}) {
...
export const SelectVisibility = () => {
    ...
    function setVisibility(visibility: CreatePostContextProviderType['visibility']) {
